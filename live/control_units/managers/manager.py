...
if __name__ == '__main__':
    ...
    leagues_dct = PickleHandler().read_data(path_to_file='data/14.04_AllLeaguesData.pkl')
    smart_dict = PickleHandler().read_data(path_to_file='data/14.04_AllTeamsData.pkl')
