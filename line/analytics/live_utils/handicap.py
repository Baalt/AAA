...
class LiveHandicapCalculation(BoundaryLiveValues):
    def calculate_handicap_1_live_data(self, home_structure, away_structure, percent):
        ...
        last_12_current_smart_handicap = self.handicap_calculation(
            current_seq=home_structure.last_12_games_individual_total_current_home_by_year_in_home_games[:12],
            opposing_seq=home_structure.last_12_games_individual_total_opposing_teams_current_home_by_year_in_away_games[:12],
            percent=percent)
        last_12_opposing_smart_handicap = self.handicap_calculation(
            current_seq=away_structure.last_12_games_individual_total_opposing_teams_current_away_by_year_in_home_games[:12],
            opposing_seq=away_structure.last_12_games_individual_total_current_away_by_year_in_away_games[:12],
            percent=percent)
    ...
    def calculate_handicap_2_live_data(self, home_structure, away_structure, percent):
        ...
        last_20_opposing_smart_handicap = self.handicap_calculation(
            ...
            percent=percent)
        last_12_current_smart_handicap = self.handicap_calculation(
            current_seq=away_structure.last_12_games_individual_total_current_away_by_year_in_away_games[:12],
            opposing_seq=away_structure.last_12_games_individual_total_opposing_teams_current_away_by_year_in_home_games[:12],
            percent=percent)
        last_12_opposing_smart_handicap = self.handicap_calculation(
            current_seq=home_structure.last_12_games_individual_total_opposing_teams_current_home_by_year_in_away_games[:12],
            opposing_seq=home_structure.last_12_games_individual_total_current_home_by_year_in_home_games[:12],
            percent=percent)
        last_8_current_smart_handicap = self.handicap_calculation(
