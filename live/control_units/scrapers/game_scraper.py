...
class RealTimeGameScraper:
    ...
    def collect_stats(self, soup, match_stat, total_text, handicap_text=None):
        ...
        for box in market_boxes:
            ...
            if scoring_category:
                ...
                elif handicap_text and category == handicap_text:
    ...
    def __get_command_boxes(self, info_box):
        command_boxes = []
        print('box_team_names = self.__get_box_command_names(info_box=info_box)')
        box_team_names = self.__get_box_command_names(info_box=info_box)
        if box_team_names:
            if len(box_team_names) == 2:
                print('box_team_names', box_team_names)
