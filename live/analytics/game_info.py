class GameInfo:
    def __init__(self, live_data, smart_data, statistic_name: str,
        ...
        self.smart_data_dct = smart_data[statistic_name]
...
----------------  + 2   ----------------
Ref15 T%: {self.smart_data_dct['ref_15_under_t2']} - {self.smart_data_dct['ref_15_under_p2']:03.2f}% 
RefAllT%: {self.smart_data_dct['ref_all_under_t2']} - {self.smart_data_dct['ref_all_under_p2']:03.2f}% 

CYear T%: {self.smart_data_dct['under_year_t2']} - {self.smart_data_dct['under_year_p2']:03.2f}% 
CSim  T%: {self.smart_data_dct['under_sim_t2']} - {self.smart_data_dct['under_sim_p2']:03.2f}% 
CL15  T%: {self.smart_data_dct['under_20_t2']} - {self.smart_data_dct['under_20_p2']:03.2f}% 
CHA   T%: {self.smart_data_dct['under_ha_t2']} - {self.smart_data_dct['under_ha_p2']:03.2f}% 
"""
