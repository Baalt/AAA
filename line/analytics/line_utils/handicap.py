    ...
    async def search_handicap_1_rate(self, statistic_name: str, league_name: str):
        for coeff_set in self.coefficients[statistic_name]['handicap_1_&coefficient']:
            try:
                ...
                similar_current_percent_low = self.handicap_calculation(
                    coeff_set=coeff_set,
                    current_seq=self.home_structure.
                ...
                similar_current_percent_high = self.handicap_calculation(
                    coeff_set=coeff_set,
                    current_seq=self.home_structure.
                ...
                similar_opposing_percent_low = self.handicap_calculation(
                    coeff_set=coeff_set,
                    current_seq=self.away_structure.
                ...
                similar_opposing_percent_high = self.handicap_calculation(
                    coeff_set=coeff_set,
                    current_seq=self.away_structure.
                ...
                if big_data_current_percent and big_data_opposing_percent:
            ...
            except (ZeroDivisionError, HandicapNotMatchSeqError) as err:
                # raise err
                print('HandicapCatcher.search_handicap_1_rate Error: ', err)
                continue
    ...
    async def search_handicap_2_rate(self, statistic_name: str, league_name: str):
        for coeff_set in self.coefficients[statistic_name]['handicap_2_&coefficient']:
            try:
                ...
                print('HandicapCatcher.search_handicap_2_rate Error: ', err)
                continue
